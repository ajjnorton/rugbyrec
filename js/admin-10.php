	...
	?>
       ...
       <button>Upload pictures</button>
        ...
        <div id="edit-dialog-modal" title="Basic modal dialog">
            ...
            <form class="edit_dialog">
            
                <label>Player:</label><input  type="text" name="player"><br>
                <label>Match:</label><input  type="text" name="match"><br>
                <label>Caption:</label><input  type="text" name="caption"><br>
                <label class="ta">Comments</label><textarea cols="40" rows="5" name="comments"></textarea>
            </form>
        </div>
